...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 8.52295288703855; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 7; // in; offset of the lateral wheel
    public static double X_MULTIPLIER = 0.9959094906; // Multiplier in the X direction
